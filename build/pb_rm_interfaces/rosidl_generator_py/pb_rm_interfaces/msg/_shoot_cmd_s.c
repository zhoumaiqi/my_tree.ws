...
bool pb_rm_interfaces__msg__shoot_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pb_rm_interfaces.msg._shoot_cmd.ShootCmd", full_classname_dest, 40) == 0);
  }
  pb_rm_interfaces__msg__ShootCmd * ros_message = _ros_message;
  {  // projectile_num
...
PyObject * pb_rm_interfaces__msg__shoot_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pb_rm_interfaces.msg._shoot_cmd");
