...
static const _ShootCmd_type_support_symbol_names_t _ShootCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pb_rm_interfaces, msg, ShootCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pb_rm_interfaces, msg, ShootCmd)),
  }
};
...
{
  return &::pb_rm_interfaces::msg::rosidl_typesupport_cpp::ShootCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pb_rm_interfaces, msg, ShootCmd)() {
  return get_message_type_support_handle<pb_rm_interfaces::msg::ShootCmd>();
}
